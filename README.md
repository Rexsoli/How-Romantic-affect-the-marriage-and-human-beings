...
The initial program is based on matlab for logic check, then the python program is largely generated by Codex. I have  check the results and the functions, but maybe still have bugs.
